namespace TeamProject_test_v1
{
    partial class 쪽지
    {
        ...
        private void InitializeComponent()
        {
            ...
            // groupBox3
            // 
            groupBox3.Controls.Add(받은쪽지_안읽은쪽지_체크박스);
            ...
            // 받은쪽지_안읽은쪽지_체크박스
            // 
            받은쪽지_안읽은쪽지_체크박스.AutoSize = true;
            받은쪽지_안읽은쪽지_체크박스.Location = new Point(345, 35);
            받은쪽지_안읽은쪽지_체크박스.Margin = new Padding(3, 2, 3, 2);
            받은쪽지_안읽은쪽지_체크박스.Name = "받은쪽지_안읽은쪽지_체크박스";
            받은쪽지_안읽은쪽지_체크박스.Size = new Size(116, 24);
            받은쪽지_안읽은쪽지_체크박스.TabIndex = 11;
            받은쪽지_안읽은쪽지_체크박스.Text = "안 읽은 쪽지";
            받은쪽지_안읽은쪽지_체크박스.UseVisualStyleBackColor = true;
            받은쪽지_안읽은쪽지_체크박스.CheckedChanged += 받은쪽지_안읽은쪽지_체크박스_CheckedChanged;
            // 
            // 받은쪽지_새로고침_버튼
            // 
            ...
            // 받은쪽지검색_버튼
            // 
            받은쪽지검색_버튼.Location = new Point(476, 24);
            ...
            // groupBox1
            // 
            groupBox1.Controls.Add(보낸쪽지_안읽은쪽지_체크박스);
            ...
            // 보낸쪽지_안읽은쪽지_체크박스
            // 
            보낸쪽지_안읽은쪽지_체크박스.AutoSize = true;
            보낸쪽지_안읽은쪽지_체크박스.Location = new Point(345, 34);
            보낸쪽지_안읽은쪽지_체크박스.Margin = new Padding(3, 2, 3, 2);
            보낸쪽지_안읽은쪽지_체크박스.Name = "보낸쪽지_안읽은쪽지_체크박스";
            보낸쪽지_안읽은쪽지_체크박스.Size = new Size(116, 24);
            보낸쪽지_안읽은쪽지_체크박스.TabIndex = 12;
            보낸쪽지_안읽은쪽지_체크박스.Text = "안 읽은 쪽지";
            보낸쪽지_안읽은쪽지_체크박스.UseVisualStyleBackColor = true;
            보낸쪽지_안읽은쪽지_체크박스.CheckedChanged += 보낸쪽지_안읽은쪽지_체크박스_CheckedChanged;
            // 
            // 보낸쪽지_새로고침_버튼
            // 
            ...
            // 보낸쪽지검색_버튼
            // 
            보낸쪽지검색_버튼.Location = new Point(476, 22);
            ...
            // 보낸쪽지검색_콤보박스
            // 
            보낸쪽지검색_콤보박스.DropDownStyle = ComboBoxStyle.DropDownList;
            보낸쪽지검색_콤보박스.Font = new Font("굴림", 10F, FontStyle.Regular, GraphicsUnit.Point);
            보낸쪽지검색_콤보박스.FormattingEnabled = true;
            보낸쪽지검색_콤보박스.Items.AddRange(new object[] { "검색조건" });
            보낸쪽지검색_콤보박스.Location = new Point(8, 37);
            보낸쪽지검색_콤보박스.Name = "보낸쪽지검색_콤보박스";
            보낸쪽지검색_콤보박스.Size = new Size(109, 25);
            보낸쪽지검색_콤보박스.TabIndex = 3;
            // 
            // 보낸쪽지검색_텍스트박스
            // 
            보낸쪽지검색_텍스트박스.Font = new Font("굴림", 10F, FontStyle.Regular, GraphicsUnit.Point);
            보낸쪽지검색_텍스트박스.Location = new Point(122, 35);
            보낸쪽지검색_텍스트박스.Name = "보낸쪽지검색_텍스트박스";
            보낸쪽지검색_텍스트박스.Size = new Size(217, 27);
            보낸쪽지검색_텍스트박스.TabIndex = 0;
            // 
            // panel1
            // 
            ...
            // 쪽지수신자부서_콤보박스
            // 
            쪽지수신자부서_콤보박스.DropDownStyle = ComboBoxStyle.DropDownList;
            쪽지수신자부서_콤보박스.FormattingEnabled = true;
            쪽지수신자부서_콤보박스.Items.AddRange(new object[] { "부서" });
            ...
            // 쪽지수신자직급이름_콤보박스
            // 
            쪽지수신자직급이름_콤보박스.DropDownStyle = ComboBoxStyle.DropDownList;
        ...
        private CheckBox 받은쪽지_안읽은쪽지_체크박스;
        private CheckBox 보낸쪽지_안읽은쪽지_체크박스;
    }
}
